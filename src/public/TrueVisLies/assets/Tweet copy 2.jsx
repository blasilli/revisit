...
'Exploit Cognitive or Visual Biases':
'The visualization is crafted to take advantage of known human perceptual or cognitive biases in order to push the reader to a particular interpretation. ',
...
'Intentional Present Information Out of Context':
...
'Unintentional Missing Context Due to Oversight':
...
'Selectively Report or Highlight Data':
'The author cherry-picks data, such as time ranges, or focuses/highlights on a data subset. The goal is to provide a skewed representation of the information.',

'Space or Format Constraints':
'Space constraints, image format, and dimension limit the design or presentation of the visualization. The author, to cope with these constraints, may incur information loss, which can lead to misrepresentation.',
  ...
  return (
    ...
    <div 
      ...
      style={{
        ...
        Visualization rhetorics definitions:
        <ul
          style={{
            fontSize: '0.9em',
          }}
        >
          {Object.entries(rhetorics).map((e) => {
            const [rhetoric, description] = e
            return (
              <li>
                <b>{rhetoric}</b>:&nbsp;
    ...
    <div 
      ...
      style={{
        ...
        >
          {Object.entries(purposes).map((e) => {
            const [purpose, description] = e
            return (
              <li>
                <b>{purpose}</b>:&nbsp;
                <span>{description}</span>
